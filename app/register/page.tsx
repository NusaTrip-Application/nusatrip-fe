            ...
            <div>
              ...
              <div className="relative">
                ...
                <input 
                  ...
                  {...register("fullName")}
                  className={`w-full pl-11 pr-4 py-3 rounded-md border bg-bg-surface focus:outline-none focus:ring-1 text-sm font-medium transition-shadow ${errors.fullName ? "border-border-error focus:border-border-error focus:ring-border-error" : "border-border-default focus:border-border-focus focus:ring-border-focus"}`}
                />
              </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input 
                  ...
                  className={`w-full pl-11 pr-12 py-3 rounded-md border bg-bg-surface focus:outline-none focus:ring-1 text-sm font-medium transition-shadow ${errors.confirmPassword ? "border-border-error focus:border-border-error focus:ring-border-error" : "border-border-default focus:border-border-focus focus:ring-border-focus"}`}
                />
                <button 
                  type="button"
