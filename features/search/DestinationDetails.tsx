...
const DESTINATION_DATABASE: Record<string, DestinationData> = {
  bandung: {
    ...
    bannerImage:
      "https://images.unsplash.com/photo-1501854140801-50d01698950b?w=1600&auto=format&fit=crop&q=80",
    paragraphs: [
    ...
    popularPlaces: [
      {
        ...
        rating: "4.8",
        description:
          "Experience the ethereal beauty of this white volcanic crater lake perched atop Mount Patuha.",
      ...
      },
      {
        ...
        rating: "4.5",
        description:
          "A unique destination where you can buy traditional Sundanese snacks from vendors on boats.",
      ...
      },
      {
        ...
        rating: "4.6",
        description:
          "Savor legendary Dutch-Indonesian fusion in a historic building located at the iconic Braga...",
  ...
  yogyakarta: {
    ...
    bannerImage:
      "https://images.unsplash.com/photo-1571896349842-33c89424de2d?w=1600&auto=format&fit=crop&q=80",
    paragraphs: [
    ...
    popularPlaces: [
      {
        ...
        rating: "4.9",
        description:
          "Explore the stunning 9th-century Hindu temple compound, dedicated to the Trimurti.",
        priceRange: "Rp 50.000 - 350.000",
        priceType: "Entrance Fee",
        image:
          "https://images.unsplash.com/photo-1584824486516-0555a07fc511?w=800&auto=format&fit=crop&q=80",
      },
      {
        ...
        rating: "4.7",
        description:
          "Experience the vibrant heart of Yogyakarta with street food, local crafts, and horse carriages.",
        priceRange: "Free",
      ...
      },
      {
        ...
        rating: "4.8",
        description:
          "Savor the authentic sweet young jackfruit dish cooked with coconut milk and local spices.",
    ...
    popularPlaces: [
      {
        ...
        rating: "4.9",
        description:
          "Witness spectacular sunsets and traditional Kecak dance performances on a cliff side temple.",
      ...
      },
      {
        ...
        rating: "4.7",
        description:
          "Marvel at the beautiful valley of rice paddies styled in traditional Balinese cooperative irrigation.",
      ...
      },
      {
        ...
        rating: "4.8",
        description:
          "Hike down to the famous T-Rex shaped coastal cliff and swim in crystal clear waters.",
...
const DEFAULT_POPULAR_PLACES: PopularPlace[] = [
  {
    ...
    rating: "4.7",
    description:
      "Explore the main historical and cultural spot that represents the rich heritage of the area.",
  ...
  },
  {
    ...
    rating: "4.6",
    description:
      "Relax in the pristine natural landscape featuring clean air, green trees, and scenic views.",
    priceRange: "Free",
    priceType: "Public Access",
    image:
  ...
  },
  {
    ...
    rating: "4.8",
    description:
      "Savor the unique traditional dishes and snacks crafted with love by local heritage cooks.",
...
export default function DestinationDetails({
  ...
  const data = DESTINATION_DATABASE[normalizedSlug] || {
    name:
      destinationSlug.charAt(0).toUpperCase() +
      destinationSlug.slice(1).replace(/-/g, " "),
    province: "Indonesia",
  ...
  const [addedItineraries, setAddedItineraries] = useState<
  ...
  return (
    <div className="w-full font-sans text-text-body bg-bg-main">
      <div
        ...
        style={{
          backgroundImage: `linear-gradient(to bottom, rgba(0, 0, 0, 0.2), rgba(0, 0, 0, 0.7)), url(${data.bannerImage})`,
        }}
      >
