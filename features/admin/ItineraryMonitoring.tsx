...
const ITINERARY_FALLBACK = "https://images.unsplash.com/photo-1552733407-5d5c46c3bb3b?w=800&auto=format&fit=crop&q=60";
                ...
                {getPageNumbers().map((pageNum) => (
                  <button
                    ...
                    className={`w-8 h-8 rounded-lg text-sm font-bold transition ${
                      page === pageNum ? "bg-brand-primary text-white" : "text-text-heading hover:bg-bg-hover"
                    }`}
                  >
                    {pageNum}
                  </button>
