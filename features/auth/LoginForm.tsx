...
export default function LoginForm() {
  ...
  return (
    <div className="min-h-screen flex w-full font-sans bg-bg-main">
      ...
      <div className="w-full md:w-1/2 flex items-center justify-center p-8 bg-bg-main">
        <div className="w-full max-w-[420px]">
          <h2 className="text-[32px] font-bold leading-[1.3] -tracking-[0.01em] text-text-heading mb-1.5">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            <div>
              <label className="block text-xs font-medium leading-[1.4] text-text-heading uppercase tracking-wide mb-2">
                Alamat Email
              </label>
              <div className="relative">
                ...
                <input 
                  ...
                  {...register("email")}
                  className={`w-full pl-11 pr-4 py-3 rounded-md border bg-bg-surface focus:outline-none focus:ring-1 text-sm font-medium transition-shadow ${errors.email ? "border-border-error focus:border-border-error focus:ring-border-error" : "border-border-default focus:border-border-focus focus:ring-border-focus"}`}
                />
              </div>
            ...
            <div>
              <div className="flex justify-between items-center mb-2">
                <label className="block text-xs font-medium leading-[1.4] text-text-heading uppercase tracking-wide">Kata Sandi</label>
                <Link href="#" className="text-xs text-brand-primary font-semibold hover:underline">Lupa Kata Sandi?</Link>
              </div>
              <div className="relative">
                ...
                <input 
                  ...
                  placeholder="••••••••" 
                  {...register("password")}
                  className={`w-full pl-11 pr-12 py-3 rounded-md border bg-bg-surface focus:outline-none focus:ring-1 text-sm font-medium transition-shadow ${errors.password ? "border-border-error focus:border-border-error focus:ring-border-error" : "border-border-default focus:border-border-focus focus:ring-border-focus"}`}
                />
                <button 
                  type="button"
            ...
            <div className="flex items-center gap-2.5 pt-1">
              <input type="checkbox" id="remember" {...register("remember")} className="w-4 h-4 rounded-sm border-border-strong text-brand-primary focus:ring-border-focus" />
          ...
          <div className="flex items-center gap-4 my-7">
            ...
            <span className="text-[11px] font-semibold text-text-muted uppercase tracking-wider">Atau masuk dengan</span>
            <div className="h-px bg-border-default flex-1"></div>
          </div>
          ...
          <p className="text-center text-sm font-medium text-text-body">
            Belum punya akun? <Link href="/register" className="text-brand-primary font-semibold hover:underline">Daftar Sekarang</Link>
          </p>
        </div>
      </div>
    </div>
